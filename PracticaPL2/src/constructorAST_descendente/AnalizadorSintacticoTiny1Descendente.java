...
public class AnalizadorSintacticoTiny1Descendente implements AnalizadorSintacticoTinyConstants {
  ...
  public AnalizadorSintacticoTiny1Descendente(java.io.InputStream stream) {
  ...
  public AnalizadorSintacticoTiny1Descendente(java.io.Reader stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new AnalizadorSintacticoTinyTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  public AnalizadorSintacticoTiny1Descendente(AnalizadorSintacticoTinyTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
